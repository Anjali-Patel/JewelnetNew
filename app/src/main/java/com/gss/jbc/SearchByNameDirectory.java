...
public class SearchByNameDirectory extends AppCompatActivity {
    ...
    public void showAlertDialog(Context context){
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(new ContextThemeWrapper(SearchByNameDirectory.this, R.style.myDialog)).create();
    ...
    private void GetUserData() {
        ...
        String url = "http://jewelnet.in/index.php/Api/search_by_key?search_by=name&key="+firstname;
                    ...
                    public void run() {
                        try {
                            ...
                            for (int i = 0; i < json2.length(); i++) {
                                ...
                                //http://jewelnet.in/assets/upload/users
                                //http://104.236.14.235/assets/upload/users/15063/2849149395c862d96a443c6.65853086_cropped-1201633732.jpg
                            ...
                            adapter = new DisplayDataUsersAdapter(SearchByNameDirectory.this,getApplicationContext(), infoDirModelList, statename, cityname, username);
                            linearLayoutManager = new LinearLayoutManager(SearchByNameDirectory.this);
