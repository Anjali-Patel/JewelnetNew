...
import com.gss.jbc.InfoDirModel;
import com.gss.jbc.R;
import com.gss.jbc.UserProfile;
...
public class DisplayDataUsersAdapter extends RecyclerView.Adapter<DisplayDataUsersAdapter.MyViewHolder> {
    private ArrayList<InfoDirModel> infoDirModelArrayList;
    Context context;
    Activity activity;
    String statename, cityname, username;

    public DisplayDataUsersAdapter(Activity activity, Context context, ArrayList<InfoDirModel> infoDirList, String statename, String cityname, String username) {
