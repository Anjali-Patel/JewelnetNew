...
public class SearchByStateDirectory extends AppCompatActivity {
    ...
    public void showAlertDialog(Context context){
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(new ContextThemeWrapper(SearchByStateDirectory.this, R.style.myDialog)).create();
    ...
    private void GetUserData() {
        ...
        String url = "http://jewelnet.in/index.php/Api/search_by_key?search_by=state&key="+statename;
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            adapter = new DisplayDataUsersAdapter(SearchByStateDirectory.this,getApplicationContext(), infoDirModelList, statename, cityname, username);
                            linearLayoutManager = new LinearLayoutManager(SearchByStateDirectory.this);
